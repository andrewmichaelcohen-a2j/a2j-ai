...
An access-to-justice plugin that screens eviction notices for procedural defects and affirmative defenses. Built to demonstrate the Andrew M Cohen model: a non-engineer attorney built this in days using Anthropic's plugin/MCP infrastructure, at essentially $0 cost.
...
This project is not a legal services provider. Every output of this plugin directs users to licensed attorneys and local legal aid organizations.
