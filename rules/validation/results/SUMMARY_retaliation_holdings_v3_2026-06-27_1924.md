...
**Run ID:** fresh_nc_batch4_20260627  
**Completed:** 2026-06-27 19:24 UTC  
**Elapsed:** 21.4 min  
**Raw output:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/l2/output/retaliation_holdings_v3_2026-06-27_fresh_nc_batch4_20260627.json`  
**PR list:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/l2/output/retaliation_holdings_v3_PR_fresh_nc_batch4_20260627.json`  
**Log:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/logs/retaliation_holdings_v3_20260627_1903.log`  

## Rates — TWO rates, never one blended number

**Method rate** (text-retrievable cases only):  MV ÷ (MV+CI+RC) = 3 ÷ 3 = **100%**
**Overall rate** (all cases, retrieval-gated):  MV ÷ all = 3 ÷ 22 = **14%**
...
|--------|-------|------------|---------|
| MV — machine-verified | 3 | 14% | Two-model corroborated; below attorney line |
...
| PR — pending-retrieval | 11 | 50% | No usable text from CL; retrieval retry only |
| SM — single-model-preliminary | 0 | 0% | Only one model answered; not machine-verified |
| Other (failure/unknown) | 8 | 36% | See raw output |
