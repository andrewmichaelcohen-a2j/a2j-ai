...
**Run ID:** 21c5b706  
**Completed:** 2026-06-26 00:24 UTC  
**Elapsed:** 2.7 min  
**Raw output:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/l2/output/retaliation_holdings_v3_2026-06-26_21c5b706.json`  
**PR list:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/l2/output/retaliation_holdings_v3_PR_21c5b706.json`  
**Log:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/logs/retaliation_holdings_v3_20260626_0021.log`  

## Rates — TWO rates, never one blended number

**Method rate** (text-retrievable cases only):  MV ÷ (MV+CI+RC) = 0 ÷ 0 = **n/a**
**Overall rate** (all cases, retrieval-gated):  MV ÷ all = 0 ÷ 17 = **0%**
...
| Other (failure/unknown) | 17 | 100% | See raw output |
