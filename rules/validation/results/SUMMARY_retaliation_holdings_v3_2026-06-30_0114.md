...
**Run ID:** vt_houle_retry_20260629  
**Completed:** 2026-06-30 01:14 UTC  
**Elapsed:** 0.0 min  
**Raw output:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/l2/output/retaliation_holdings_v3_2026-06-30_vt_houle_retry_20260629.json`  
**PR list:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/l2/output/retaliation_holdings_v3_PR_vt_houle_retry_20260629.json`  
**Log:** `/Users/andrewcohen/Documents/GitHub/a2j-ai/rules/validation/logs/retaliation_holdings_v3_20260630_0114.log`  

## Rates — TWO rates, never one blended number

**Method rate** (text-retrievable cases only):  MV ÷ (MV+CI+RC) = 0 ÷ 0 = **n/a**
**Overall rate** (all cases, retrieval-gated):  MV ÷ all = 0 ÷ 1 = **0%**
...
| Other (failure/unknown) | 1 | 100% | See raw output |
